...
const Privacy = () => {
  return (
    <div>
        <Cover title="Privacy Policy" />
      <div className="container px-5 mx-auto">
        <h1 className="text-3xl mt-10">Privacy Policy</h1>
        ...
        <ul>
          ...
          <li>
            <div>
              ...
              in this Agreement) refers to Corporation, Holding# 4602,
              Komaigari, Naogaon Sador, Naogaon-6500.
            </div>
          </li>
          <li>
            <div>
        ...
        <h2 className="text-2xl mt-3">Collecting and Using Your Personal Data</h2>
        <h3 className="text-xl mt-3">Types of Data Collected</h3>
        <h4>Personal Data</h4>
        <div>
        ...
        <h3 className="text-xl mt-3">Use of Your Personal Data</h3>
        ...
        <h3 className="text-xl mt-3">Retention of Your Personal Data</h3>
        <div>
        ...
        <h3 className="text-xl mt-3">Transfer of Your Personal Data</h3>
        <div>
        ...
        <h3 className="text-xl mt-3">Delete Your Personal Data</h3>
        <div>
        ...
        <h3 className="text-xl mt-3">Disclosure of Your Personal Data</h3>
        ...
        <h3 className="text-xl mt-3">Security of Your Personal Data</h3>
        <div>
        ...
        <h2 className="text-2xl mt-3">Childrens Privacy</h2>
        <div>
        ...
        <h2 className="text-2xl mt-3">Changes to this Privacy Policy</h2>
        <div>
