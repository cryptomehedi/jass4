...
const TermesAndConditions = () => {
  return (
    <div>
      <Cover title="Terms & Conditions" />
      <div className="container px-5 mx-auto">
        <div className=" ">
          <h1 className="text-3xl mt-10">Terms and Conditions</h1>
          <div className="my-5">Last updated: January 27, 2024</div>
          <div>
          ...
          <ul>
            ...
            <li>
              <div>
                By phone number: +8801602510206 , +8801727740016 ,
                +8801764637898 , +8801781512141
              </div>
            </li>
          </ul>
        </div>
