const TermesAndConditions = () => {
  return (
    <div className="container mx-auto">
      ...
      <h2 className="text-2xl mt-3">Interpretation and Definitions</h2>
      <h3 className="text-xl mt-3">Interpretation</h3>
      <p>
      ...
      <h3 className="text-xl mt-3">Definitions</h3>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to JASS4 Brothers Petroleum Ltd., Holding#
            4602, Komaigari, Naogaon Sador, Naogaon-6500.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to JASS4 Lubricants, accessible from{" "}
            <a
      ...
      <h2 className="text-2xl mt-3">Acknowledgment</h2>
      <p>
      ...
      <h2 className="text-2xl mt-3">Links to Other Websites</h2>
      <p>
      ...
      <h2 className="text-2xl mt-3">Termination</h2>
      <p>
      ...
      <h2 className="text-2xl mt-3">Limitation of Liability</h2>
      <p>
      ...
      <h2 className="text-2xl mt-3">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
      <p>
      ...
      <h2 className="text-2xl mt-3">Governing Law</h2>
      <p>
      ...
      <h2 className="text-2xl mt-3">Disputes Resolution</h2>
      <p>
      ...
      <h2 className="text-2xl mt-3">For European Union (EU) Users</h2>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which You are
        resident.
      </p>
      <h2 className="text-2xl mt-3">United States Legal Compliance</h2>
      <p>
      ...
      <h2 className="text-2xl mt-3">Severability and Waiver</h2>
      <h3 className="text-xl mt-3">Severability</h3>
      <p>
      ...
      <h3 className="text-xl mt-3">Waiver</h3>
      <p>
        Except as provided herein, the failure to exercise a right or to require
        performance of an obligation under these Terms shall not affect a
        partys ability to exercise such right or require such performance at
        any time thereafter nor shall the waiver of a breach constitute a waiver
        of any subsequent breach.
      </p>
      <h2 className="text-2xl mt-3">Translation Interpretation</h2>
      <p>
      ...
      <h2 className="text-2xl mt-3">Changes to These Terms and Conditions</h2>
      <p>
      ...
      <h2 className="text-2xl mt-3">Contact Us</h2>
      <p>
      ...
      <ul>
        <li>
          <p>By email: jass4best@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://jass4.com/contact"
              rel="external noreferrer nofollow noopener"
              target="_blank"
            >
              https://jass4.com/contact
            </a>
          </p>
        </li>
        <li>
          <p>
            By phone number: +8801602510206 , +8801727740016 , +8801764637898 ,
            +8801781512141
          </p>
        </li>
      </ul>
