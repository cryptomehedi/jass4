    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-2 mt-10 items-center md:mt-20 overflow-hidden">
        <div className="mt-14 px-4 md:px-16">
          ...
          <button className="bg-[#1F2A7D] text-white font-semibold mt-3 p-2 px-3 md:px-5 rounded-full hover:font-bold md:mt-4 hover:bg-orange-500 duration-500 text-center">
            Learn More
          </button>
        </div>
