                            ...
                            products.map(product =>{
                                return   <Link to={`/products/product/${product.id}`} key={product.id} className="card card-compact w-5/6 md:w-96 bg-base-100 p-5 m-5 shadow-xl">
                                            ...
                                            <div className="card-body ">
                                                ...
                                                <p className='text-lg' >{product.power}</p>
                                                <div className="card-actions justify-end">
                                                    {
                                                        typeof(product.Weight) === "number" ? <div className='text-base' >Weight : {product.Weight}L</div> : <div className='text-lg' >Weight : {product.Weight}</div>
                                                    }
                                                </div>
                                            </div>
                                        </Link>
