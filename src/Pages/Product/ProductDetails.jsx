            ...
            <section className="body-font overflow-hidden">
                <div className="container w-full px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 w-5/6 mx-auto flex flex-wrap">
                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto md:h-40 object-cover object-center rounded-2xl" src={mobil}/>
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <h2 className="text-base title-font uppercase mt-6 tracking-widest">Product Price</h2>
